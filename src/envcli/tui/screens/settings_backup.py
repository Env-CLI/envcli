...
class SettingsScreen(Container):
    ...
    def _create_settings_widgets(self):
        ...
        with Horizontal(classes="setting-actions"):
            yield Button("* Configure AI Provider", variant="primary", id="config-ai-btn")
        ...
        with Horizontal(classes="setting-actions"):
            yield Button("Toggle Remember Last", variant="default", id="toggle-remember-btn")
        ...
        with Horizontal(classes="setting-actions"):
            yield Button("Toggle Analytics", variant="default", id="toggle-analytics-btn")
        ...
        with Horizontal(classes="setting-actions"):
            yield Button("📂 Open Config Directory", variant="default", id="open-config-btn")
            yield Button("@ Refresh Settings", variant="default", id="refresh-settings-btn")
    ...
    async def refresh_settings(self) -> None:
        ...
        try:
            ...
            self.app.log("Children removed")

            # Mount new widgets
            widget_count = 0
            for widget in self._create_settings_widgets():
                widget_count += 1
                self.app.log(f"Mounting widget {widget_count}: {widget}")
